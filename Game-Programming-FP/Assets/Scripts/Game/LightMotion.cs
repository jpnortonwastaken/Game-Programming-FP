...
{
    public Vector2 m_cycleDurationXZ = new Vector2(20f, 20f);
    public AnimationCurve m_movementPathX;
    public AnimationCurve m_movementPathZ;
    public Vector2 m_movementMagnitudeXZ = new Vector2(1, 1);
    public Vector2 m_movementTimeOffsetXZ = new Vector2();
